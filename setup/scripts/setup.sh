...
ansible-playbook --extra-vars "ansible_user=$username ansible_password=$password mysql_password=$password" ~/ansible/playbook/create_k8s_resources.yml -i ~/ansible/inventory/kube_inventory